...
export const Ic = ({name, size=18, color="currentColor", strokeWidth=2, style={}}) => {
  const p = {
    ...
    "dumbbell":      <><path d="M6.5 6.5l11 11"/><path d="M4 9l3-3"/><path d="M2.5 7.5l4-4"/><path d="M17 20l3-3"/><path d="M17.5 21.5l4-4"/></>,
