  ...
  return (
    ...
    >
      {libNarrow ? (
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: '8px' }}>
            ...
            <div style={{ display: 'flex', gap: '6px', flexShrink: 0 }}>
              ...
              <button
                type="button"
                onClick={onEdit}
                style={{ width: 30, height: 30, display: "flex", alignItems: "center", justifyContent: "center", background: '#111827', border: '1px solid #1E293B', borderRadius: 7, cursor: "pointer", flexShrink: 0, fontFamily: "inherit", padding: 0, color: textMuted }}
              >
                <Ic name="link" size={13}/>
              </button>
              {isCustom && (
                <button
                  type="button"
        ...
        <div style={{ display:"flex", alignItems: "flex-start", gap: 10, flexWrap: "wrap", flexDirection: "row" }}>
          ...
          >
            ...
            <button
              type="button"
              onClick={onEdit}
              style={{ width: 42, height: 42, display: "flex", alignItems: "center", justifyContent: "center", background: _dm ? "rgba(22, 34, 52, 0.6)" : bgSub, color: textMuted, border: "1px solid " + cardBorder, borderRadius: 12, cursor: "pointer", fontSize: 15, flexShrink: 0, fontFamily: "inherit", padding: 0 }}
            >
